                ...
                <div className="flex  flex-col-reverse md:flex-row justify-between gap-4 md:gap-0 flex-wrap  items-center">
                    <div className="md:w-[48%] w-full ">
                        <p className=" text-[15px] font-medium md:text-[17px] text-gray-600 pb-[15px] ">
                            <span className="text-[20px] block pb-4 font-semibold">Welcome to <span className="text-primary-color ">RH IT</span>,</span>
                        ...
                        <div className="text-[18px] font-semibold text-slate-600  ">
                            ...
                            <div className="flex  gap-4 ">
                                ...
                                <a href="https://www.facebook.com/rhitrakib"
                                    target="_blank"
                    ...
                    <div className="md:w-[48%] w-full ">
                        <img className="w-full h-full object-cover " loading="lazy" src={contact} alt="contact" />
                    </div>
